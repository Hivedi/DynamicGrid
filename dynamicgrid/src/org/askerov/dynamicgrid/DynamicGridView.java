...
public class DynamicGridView extends GridView {
	...
	private int mWobbleStart = -2;
	private int mWobbleEnd = 2;
	...
	public void setWobbleParams(int start, int end) {
		mWobbleStart = start;
		mWobbleEnd = end;
	}
	...
	private BitmapDrawable getAndAddHoverView(View v) {
		...
		//b = addShadow(b, b.getHeight(), b.getWidth(), Color.BLACK, 5, 3, 3);
	...
	private OnBeforeDragStart mOnBeforeDragStart;
	public void setOnBeforeDragStart(OnBeforeDragStart o) {
		mOnBeforeDragStart = o;
	}
	...
	private void startDragAtPosition(int position) {
		...
		if (selectedView != null) {
			if (mOnBeforeDragStart != null)
				mOnBeforeDragStart.onBeforeDragStart(position, selectedView);
